...
export const REMINDERS = [
  "아직 오늘 채굴 안 하셨죠? 지금 곡괭이 들 시간이에요 ⛏️",
  "금맥이 기다리고 있어요. 오늘 몫, 잊지 않으셨죠?",
  "하루가 다 가기 전에 오늘의 금 한 조각 캐러 가볼까요?",
  "잠깐, 오늘 채굴 하셨나요? 아직이면 지금이 딱 좋은 타이밍이에요.",
  "작업반장입니다! 오늘 채굴 아직 안 하신 분, 얼른 다녀오세요 💪🏻",
  "꾸준함이 금맥을 만듭니다. 오늘 몫도 잊지 말아주세요.",
  "오늘의 금, 아직 캐지 않으셨다면 지금이 기회예요.",
  "곡괭이 챙기고 오늘의 채굴, 잊지 말고 완료해주세요!",
];
